...
// func TestAccGKEHub2ScopeRBACRoleBinding_gkehubScopeCustomRbacRoleBindingBasicExample(t *testing.T) {
//         t.Parallel()
...
// func testAccGKEHub2ScopeRBACRoleBinding_gkehubScopeCustomRbacRoleBindingBasicExample(context map[string]interface{}) string {
//         return acctest.Nprintf(`
